...
export const metadata = {
  title: "Privacy Policy | EliteUKCasinoSites.com",
  description:
...
const sections = [
  ...
  },
  {
    ...
    body: "Our website contains links to external casino sites and third-party services. We are not responsible for the privacy practices of these external sites. We recommend reviewing their privacy policies before providing personal information.",
  },
  {
  ...
  {
    title: "11. Contact Us",
    body: "For questions or to exercise your data rights, contact us at: privacy@eliteukcasinosites.com. You also have the right to lodge a complaint with the UK Information Commissioner's Office (ICO) at ico.org.uk.",
  },
]
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <p className="text-sm text-muted-foreground leading-relaxed mb-10 border-l-2 border-accent pl-5">
              At EliteUKCasinoSites.com, safeguarding your privacy is our paramount concern. This Privacy Policy outlines how we collect, use, store, and protect your personal information in full compliance with UK GDPR and the Data Protection Act 2018.
            </p>
