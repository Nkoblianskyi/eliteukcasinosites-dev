...
export const metadata = {
  title: "Cookie Policy | EliteUKCasinoSites.com",
  description:
    "Understand how eliteukcasinosites.com uses cookies and tracking technologies, and how to manage your preferences.",
}
...
const sections = [
  ...
  },
  {
    ...
    body: "First-party cookies are set directly by eliteukcasinosites.com and are used primarily for site functionality and analytics. Third-party cookies are set by external services such as Google Analytics, social media platforms, and advertising networks, each governed by their own privacy policies.",
  },
  {
  ...
  {
    title: "8. Contact Us",
    body: "If you have questions about our cookie practices or wish to exercise your data rights, please contact us at cookies@eliteukcasinosites.com.",
  },
]
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <p className="text-sm text-muted-foreground leading-relaxed mb-10 border-l-2 border-accent pl-5">
              This Cookie Policy explains how EliteUKCasinoSites.com uses cookies and similar tracking technologies when you visit our website, in compliance with the Privacy and Electronic Communications Regulations (PECR) and UK GDPR.
            </p>
